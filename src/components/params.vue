<template>
    <div class="user-container">
        ...
        <el-row class="mt">
            <el-col :span="24">
                <el-alert title="注意:只允許為第三級分類設置相關參數" type="warning" show-icon>
                </el-alert>
            </el-col>
        </el-row>
        <!-- 級聯選擇器 -->
        <el-row>
            <el-col :span="24">
                <span class="mr">請選擇商品分類:</span>
                <el-cascader expand-trigger="hover" :options="paramList" v-model="selectedOptions2" :props="props">
                </el-cascader>
            </el-col>
        </el-row>
        <!-- tabs -->
